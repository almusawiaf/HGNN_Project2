...
export disease_data_path='/home/almusawiaf/MyDocuments/PhD_Projects/HGNN_Project2/Data'

export NUM_DISEASES=203
export DISEASE_FILE='DMPLB2'
export similarity_type='PC'

export num_Sample=501
export r_u_sampling='True'
export SNF_ing='False'
experiment_name="501_patients"


# Create a new directory with the job name and timestamp
output_dir="/home/almusawiaf/PhD_Projects/HGNN_Project2/Data_Generation2/experiments"
